...
export const ColorModeSwitcher = props => {
  ...
  return (
    <Flex p={4}>
      <svg height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={() => toggleMode()} filter='drop-shadow(3px 5px 2px rgb(0 1 1 / 0.5)' >
        <rect width="47.4353" height="47.4353" rx="23.7176" fill="black" />
    ...
    //   m={4}
    //   boxShadow={toggle ? '' : '0px 0px 10px #a5a5a5'}
    //   onClick={() => toggleMode()}
    //   icon={<Icon as={svg} />}
    //   isRound
    //   {...props}
